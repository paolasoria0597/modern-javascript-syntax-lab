...
const secondArray = nums.map((number)=> {
    return number * 2
})
...
sentence('dog', 'brown'); //assign new arguments
...
// Your code here
let pizza ='tasty';
let raiting = pizza === 'tasty' ? 'tasty' : 'yuck'; 
console.log(raiting); 
...
// Define LANG before using it in the console.log
